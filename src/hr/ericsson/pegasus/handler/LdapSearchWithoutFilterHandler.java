 ...
 * <HR>
 * This handler is used for LDAP search requests. It's a modification with disabled LDAP filter matching.
 * <HR>
 * @author eigorde
 *
 */
public class LdapSearchWithoutFilterHandler extends LdapSearchHandler {
	 ...
	 */
	public LdapSearchWithoutFilterHandler() {
	...
	public LDAPMessage processSearchRequest(int messageID,
		...
		if (dnMatch && filterMatch) {
			...
			if (baseEntry == null) {
				 ...
				 */
				List<String> requestedAttributes = request.getAttributes();
				Entry newEntry = getEntryWithRequestedAttributes(baseEntry, requestedAttributes);
